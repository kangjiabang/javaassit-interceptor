 ...
 */
@Slf4j
public class ApacheDubboConsumeInterceptor extends AgentMethodInterceptor {


    public static final ApacheDubboConsumeInterceptor instance = new ApacheDubboConsumeInterceptor();

    public ApacheDubboConsumeInterceptor() {

    }

    public  static ApacheDubboConsumeInterceptor getInstance() {
        return instance;
    }
    ...
    public BeforeMethodResult beforeMethod(Object instance, Class clazz, String methodName, Object[] args) {
        try {
            ...
            log.info("--------------- ApacheDubboConsumeInterceptor invoke dubbo.Stresstag is =>>>" + stressTag);

        } catch (Throwable e) {
            log.error("fail to execute ApacheDubboConsumeInterceptor beforeMethod.",e);
            throw new AgentException("fail to execute ApacheDubboConsumeInterceptor beforeMethod." + ExceptionUtils.getStackTrace(e));
        }
        return null;
    }
    ...
    public void handleException(Object instance, Class clazz, String methodName, Object[] args, Throwable e) {
        log.error("fail to execute ApacheDubboConsumeInterceptor interceptor.",e);
    }
}
